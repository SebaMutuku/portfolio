    ...
    const EducationCard = () => {
        return (
            ...
            >
                ...
                >
                    <CardContent sx={{ backgroundColor: appColors.primary, borderTopLeftRadius: 12, borderTopRightRadius: 12 }}>
                        <Typography variant="h4" component="div" gutterBottom fontFamily="Josefin Sans" color={appColors.white}>
                    ...
                    <CardContent sx={{ backgroundColor: appColors.white }}>
                        ...
                        <Typography variant="h4" component="div" gutterBottom fontFamily="Josefin Sans" color={appColors.primary}>
                            Certifications
                        </Typography>

...
// Type for the ExperienceSection props
    ...
    return (<Card variant="outlined" sx={{marginBottom: 4}}>
        <CardContent>
            ...
            <Typography variant="body1" fontFamily="Josefin Sans" paragraph>
                ...
                talented software
                developer with strong proficiency in Java, Spring, Spring Boot, and web service creation (SOAP and
                REST). Experienced
            ...
            <Typography variant="body1" fontFamily="Josefin Sans" paragraph>
                ...
                Team Foundation Git.
                Deep knowledge of Docker, Kubernetes, OpenShift, Spring Cloud, and Configuration Server. Proficient
                in Linux,
            ...
            <Typography variant="body1" fontFamily="Josefin Sans" paragraph>
                ...
                React JS.
                Worked extensively with financial applications including Temenos and Finacle, and their related
                systems.
            </Typography>
            <Typography variant="body1" fontFamily="Josefin Sans" paragraph>
                Specialized in building health-related software using the Google FHIR SDK and FHIR Resources.
                Experienced
                with the J-easy Rules Engine for implementing complex business logic. Strong focus on scalable
                backend
                ...
                <Box component="ul" sx={{paddingLeft: 2}}>
                    {exp.responsibilities.map((item, i) => {
                        ...
                        return isHeader ? (<Typography
                            ...
                            variant="body2"
                            sx={{
                                textDecoration: "underline", fontWeight: 600, marginTop: 1, marginLeft: "-1.5em", // aligns with list
                            }}
                            component="div"
                        >
                            {item}

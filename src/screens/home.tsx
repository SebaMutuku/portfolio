...
const WhatIDo = () => {
    const cardData = [{
        ...
        description: ["Java 8,11,17,21, Python 2,3, TypeScript , Kotlin 1.6+, Rust, Go", "PostgreSQL , CockroachDB, TimescaleDB, YugabyteDB, AWS Aurora, PlanetScale", "MongoDB Atlas, Redis Enterprise, ScyllaDB, Amazon DocumentDB, Firebase Firestore, AWS DynamoDB, Neo4j", "Spring Boot 3, Quarkus, Micronaut 4, Helidon", "FastAPI, Django 5.0, Starlette, Pydantic", "NestJS 10, Next.js 14, Remix, tRPC, Astro", "Ktor 2, Spring Boot 3 with Kotlin Coroutines, KMP (Kotlin Multiplatform), Compose Multiplatform", "GraphQL (Apollo Server 4), gRPC, tRPC, WebSocket, Server-Sent Events, Apache Kafka, RabbitMQ, WebAssembly, Cloudflare Workers, Vercel Edge Functions", "JUnit 5, Testcontainers, Kotest, MockK, RestAssured, Selenide, Playwright, Vitest, Jest, Testing Library, Cypress, MSW (Mock Service Worker), Pytest, Hypothesis, Robot Framework, Locust", "Serverless Framework, AWS CDK, Pulumi, AWS Lambda, Google Cloud Run, Vercel, Netlify, Railway, Fly.io, Docker, Kubernetes, Terraform, ArgoCD, GitLab CI, GitHub Actions", "Grafana, Prometheus, Loki, Tempo, OpenTelemetry, Datadog, New Relic, Jaeger", "HashiCorp Vault, AWS IAM, OAuth 2.0, OpenID Connect, JWT, PASETO"]
    }, {
